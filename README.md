...
v2:
pyinstaller --noconfirm --onedir --windowed --clean --onefile --icon "logo.ico" --name "PDFManager" --add-data "Gui;Gui/" --hidden-import "PyPDF2" --hidden-import "PyQt5.QtWidgets" --add-data "logo.png;." "Main.py"
```